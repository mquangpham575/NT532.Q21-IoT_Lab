...
def upload_img_file():
    if request.method == 'POST':
        ...
        # OpenCV decodes images as BGR by default, while this pipeline (MTCNN/FaceNet)
        # expects RGB-like ordering.
        ...
        print(f"[RECOG] Identity: {name:10} | Prob: {prob:.4f} | Latency: {latency:6.2f}ms", flush=True)
